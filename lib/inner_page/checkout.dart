        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: data['address'] == '' ? TextButton(onPressed: (){
                 Navigator.push(context, MaterialPageRoute(builder: (context) => EditProfile(userData: data,)));
              }, child:  Text('Enter Billing Address',style: GoogleFonts.righteous(fontSize:18,color: Colors.cyan.shade400),)) : ElevatedButton.icon(
                style: ElevatedButton.styleFrom(
                ...
                onPressed: () {
                  ...
                  _cartProvider.getCartItem.forEach((key, item) {
                    ...
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const MainPage())).whenComplete(() => Navigator.pop(context));
                    } );
                  });
